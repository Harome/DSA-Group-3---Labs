class Graph:
    ...
    def display_stations(self):
        ...
        print(", ".join(lrt1_stations))
        print("\nLRT-2 Stations:")
        print(", ".join(lrt2_stations))
        print("\nMRT-3 Stations:")
        print(", ".join(mrt3_stations))
...
mrt_graph.display_stations()

start_station = input("\nEnter your start station: ")
end_station = input("\nEnter your end station: ")
shortest_path_length, shortest_path_stations = mrt_graph.shortest_path(start_station, end_station)

print(f"The shortest path from {start_station} to {end_station} is {shortest_path_length} stations:")
print(" -> ".join(shortest_path_stations))
